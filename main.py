...
print("Za jego pomocą obliczysz stawkę tłumacza za postedycję tłumaczenia maszynowego.\n")
...
def main():
  ...
  #Obliczenie ilości dopasowań segmentów o konkretnych wartościach: match1 (0-74%), match2 (75-84%), match3 (85-94%)...
  ...
  #Obliczanie wartości dopasowania poprzez pomnożenie ilości segmentów o konkretnym stopniu dopasowania razy przypisaną im wartość
  ...
  if (mtqe >= 0.7):
    ...
    #W skład stawki za postedycję wchodzi weryfikacja tekstu oraz jakość tłumaczenia maszynwego i dopasowań z pamięci tłumaczeniowych. Im lepsza jakość tłumaczenia maszynowego tym niższa stawka za postedycję i vice versa.
    ...
    print()
    #Obliczenie stawki tłumacza za tłumaczenie wykonane poza Phrase
